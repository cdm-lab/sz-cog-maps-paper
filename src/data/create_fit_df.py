...
def main():
    parser = argparse.ArgumentParser(
        description="Code to generate dataframes of subject fits for the two step task"
    )
    parser.add_argument(
        "-i",
        "--input_path",
        required=True,
        help="point to where you are pulling pickle files from",
    )
    parser.add_argument(
        "-s",
        "--sublist",
    ...
    parser.add_argument(
        ...
        "--colname_list",
        required=False,
        help="file containing list of names for dataframe column",
        default=None,
    )
    ...
    if colname_list is None:
        column_names = {
            ...
            4: "lambda init",
            5: "lambda fit",
            6: "w low stakes low arm init",
            7: "w low stakes low arm fit",
            8: "w high stakes low arm init",
            9: "w high stakes low arm fit",
            10: "w low stakes high arm init",
            11: "w low stakes high arm fit",
            12: "w high stakes high arm init",
            13: "w high stakes high arm fit",
            14: "stickiness init",
            15: "stickiness fit",
            16: "resp stickiness init",
            17: "resp stickiness fit",
            18: "eta init",
            19: "eta fit",
            20: "kappa init",
            21: "kappa fit",
        ...
        assert os.path.exists(
            colname_list
        ), "provided filename for column names does not exist!"
